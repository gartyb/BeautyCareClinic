...
export const orders: CustomerOrder[] = [
  // cust-1: order with facial series + laser series, partial payment
  {
    ...
    paymentCount: 2,
    orderItems: [
      { id: 'oi-1', packageTypeId: 'pt-1', treatmentSeriesId: 'series-1' },
      { id: 'oi-2', packageTypeId: 'pt-2', treatmentSeriesId: 'series-2' },
    ],
  ...
  // cust-2: Swedish + medical massage timer series, partial payment
  {
    ...
    paymentCount: 1,
    orderItems: [
      { id: 'oi-4', packageTypeId: 'pt-3', treatmentSeriesId: 'series-3' },
      { id: 'oi-5', packageTypeId: 'pt-5', treatmentSeriesId: 'series-4' },
    ],
  ...
  // cust-3: two completed series, fully paid
  {
    ...
    paymentCount: 2,
    orderItems: [
      { id: 'oi-7', packageTypeId: 'pt-1', treatmentSeriesId: 'series-5' },
      { id: 'oi-8', packageTypeId: 'pt-2', treatmentSeriesId: 'series-6' },
    ],
  ...
  // cust-4: new order, no payments
  {
    ...
    paymentCount: 0,
    orderItems: [
      { id: 'oi-10', packageTypeId: 'pt-1', treatmentSeriesId: 'series-7' },
    ],
  ...
  // cust-5: Swedish massage series, partial payment
  {
    ...
    paymentCount: 1,
    orderItems: [
      { id: 'oi-11', packageTypeId: 'pt-3', treatmentSeriesId: 'series-8' },
    ],
  ...
  // cust-5: completed laser series, fully paid
  {
    ...
    paymentCount: 3,
    orderItems: [
      { id: 'oi-12', packageTypeId: 'pt-2', treatmentSeriesId: 'series-9' },
    ],
